...
exports.addMoney = (req, res) => {
  ...
  db.query(updateBalanceQuery, [amount, username], (error, results) => {
    if (error) {
      ...
      return res
        .status(500)
        .json({ message: "An error occurred while adding money" });
    }

    db.query(
      "SELECT balance_ron, balance_usd, balance_eur FROM accounts WHERE user_id = (SELECT id FROM users WHERE username = ?)",
      [username],
      (balanceError, balanceResults) => {
        if (balanceError) {
          ...
          return res
            .status(500)
            .json({
              message: "An error occurred while retrieving updated balances",
            });
        }
    ...
    (error, senderResults) => {
      if (error) {
        ...
        return res
          .status(500)
          .json({
            message: "An error occurred while checking sender's balance",
          });
      }
        ...
        (error, senderAccountResults) => {
          if (error) {
            ...
            return res
              ...
              .json({
                message:
                  "An error occurred while fetching sender's account balances",
              });
          }
          ...
          const senderBalance =
            senderBalances[`balance_${currency.toLowerCase()}`];
            ...
            (error, recipientResults) => {
              if (error) {
                ...
                return res
                  .status(500)
                  .json({
                    message: "An error occurred while fetching recipient's ID",
                  });
              }
                ...
                (error, recipientAccountResults) => {
                  if (error) {
                    ...
                    return res
                      ...
                      .json({
                        message:
                          "An error occurred while fetching recipient's account balances",
                      });
                  }
                  ...
                  const recipientBalance =
                    recipientBalances[`balance_${currency.toLowerCase()}`];
                    ...
                    (error, results) => {
                      if (error) {
                        ...
                        return res
                          ...
                          .json({
                            message:
                              "An error occurred while updating sender's balance",
                          });
                      }
                      ...
                      db.query(
                        ...
                        [updatedRecipientBalance, recipientId],
                        (error, results) => {
                          if (error) {
                            console.log(error);
                            return res
                              ...
                              .json({
                                message:
                                  "An error occurred while updating recipient's balance",
                              });
                          }
                            ...
                            (error, results) => {
                              if (error) {
                                ...
                                return res
                                  ...
                                  .json({
                                    message:
                                      "An error occurred while recording transaction for sender",
                                  });
                              }
                              ...
                              db.query(
                                insertRecipientTransactionQuery,
                                [
                                  recipientId,
                                  "Transfer",
                                  amount,
                                ...
                                (error, results) => {
                                  if (error) {
                                    ...
                                    return res
                                      ...
                                      .json({
                                        message:
                                          "An error occurred while recording transaction for recipient",
                                      });
                                  }
    ...
    (error, results) => {
      if (error) {
        ...
        return res
          .status(500)
          .json({
            message: "An error occurred while retrieving sender's information",
          });
      }
          ...
          db.beginTransaction((error) => {
            if (error) {
              ...
              return res
                .status(500)
                .json({
                  message: "An error occurred while starting transaction",
                });
            }
            ...
            db.query(
              ...
              (error) => {
                if (error) {
                  return db.rollback(() => {
                    ...
                    return res
                      ...
                      .json({
                        message:
                          "An error occurred while deducting money from sender",
                      });
                  });
                }
                ...
                db.query(
                  "INSERT INTO bill_payments (user_id, bill_type_id, recipient, account_number, amount, due_date, reference) VALUES (?, ?, ?, ?, ?, ?, ?)",
                  [
                    userId,
                    billType,
                    billRecipient,
                  ...
                  (error) => {
                    if (error) {
                      return db.rollback(() => {
                        ...
                        return res
                          ...
                          .json({
                            message:
                              "An error occurred while recording bill payment",
                          });
                      });
                    }
                    ...
                    db.query(
                      "INSERT INTO transactions (user_id, transaction_type, amount, recipient, date) VALUES (?, ?, ?, ?, NOW())",
                        ...
                        if (error) {
                          return db.rollback(() => {
                            ...
                            return res
                              ...
                              .json({
                                message:
                                  "An error occurred while recording transaction for bill payment",
                              });
                          });
                        }
...
exports.exchangeMoney = (req, res) => {
  ...
  db.query(getUserIdQuery, [username], (err, results) => {
    if (err) {
      ...
      return res
        .status(500)
        .json({ message: "An error occurred while fetching user ID" });
    }
    ...
    db.query(
      ...
      (err, results) => {
        ...
        db.query(
          updateAccountQuery,
          [amount, finalExchangedAmount, userId],
          (err) => {
            if (err) {
              ...
              return res
                .status(500)
                .json({
                  message: "An error occurred while updating account balances",
                });
            }
            ...
            db.query(
              ...
              (err) => {
                ...
                res.json({
                  ...
                  exchangedAmount: finalExchangedAmount,
                });
              }
            );
          }
